      ...
      <div className="">
        <div className="text-center flex flex-col justify-center container mx-auto xl:pt-40 xl:text-left">
          <motion.h1
            ...
            className="h1"
          >
            <div className="flex items-center justify-center gap-x-2 xl:justify-start xl:mb-[-30px] vsm:text-2xl vsm:mt-10 md:text-3xl xl:text-4xl">
              Hi! Welcome
              <HiFaceSmile className="animate-bounce text-secondary" /> <br />
            </div>
            <span className="text-[#e68e2e] opacity-80 text-xl md:text-2xl vsm:text-sm xl:mt-3">I&apos;M A FULLSTACK DEVELOPER</span>
          </motion.h1>
          <motion.p
            ...
            animate="show"
            exit="hidden"
            className="max-w-sm text-white xl:max-w-xl mx-auto xl:mx-0 mb-10 xl:mb-16 vsm:-mt-3 xl:-mt-5"
          >
